...
const Contact = () => {
   return (
    <section id="contact-and-resume" className="flex min-h-screen w-full flex-col items-center justify-center text-white px-8 py-16">
      <h2 className="text-4xl font-bold mb-8">Contact & Resume</h2>

      <div className="flex flex-col gap-8">
        {/* Contact Section */}
        <div className="flex flex-col items-center justify-center gap-3 space-y-6 p-14 border border-white rounded-lg">
        ...
        <a
          href={resumePDF}
          download
          className="bg-transparent border border-white hover:bg-white hover:text-black py-3 px-6 rounded-lg transition-all duration-300 self-start"
        >
          Download Resume
        </a>
      </div>
