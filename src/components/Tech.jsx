...
import { SiMysql } from 'react-icons/si'; // MySQL icon from Simple Icons
  ...
  return (
    <div id='tech' className='flex min-h-[70vh] w-full flex-col items-center justify-center gap-16 md:gap-32'>
      ...
      <div className='flex flex-wrap items-center justify-center gap-10 p-5'>
        ...
        {/* MySQL */}
        <motion.div variants={variants} initial='hidden' whileInView='visible' transition={{ duration: 0.5 }}>
          <SiMysql className='cursor-pointer text-[80px] text-blue-600 transition-all duration-300 hover:-translate-y-5 sm:text-[100px] md:text-[120px]' />
        </motion.div>
      </div>
    </div>
  );
