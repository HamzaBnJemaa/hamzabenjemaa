...
<p className='md:text-base text-pretty text-sm text-gray-400'>
  i'm a Web & mobile Devel, skilled in ReactJs, Next.js, javascipt, and Tailwind, focused on builduing clean, scalable applications. From front-end design to seamless database integration with mySQL, I create efficient sollutions for dynamic user experiences. Let's build something Great for toghether !
</p>
  </motion.div>
</div>
</div>
